...
4. Use `pipenv` to set up a virtual environment and install the required dependencies for FastAPI and Uvicorn:
...
5. Open the directory in Visual Studio Code to begin working:
